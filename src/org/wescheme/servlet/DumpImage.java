...
import org.wescheme.data.DAOIMG;
 ...
 *
 */
public class DumpImage extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		Query<Picture> query = ofy.query(Picture.class);
		...
		QueryResultIterator<Picture> iterator = query.iterator();
